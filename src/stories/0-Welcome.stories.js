...
export const ToStorybook = () => (
  <>
    ...
    <ul>
      <li>Components in <em>common</em> do not have any external dependency.</li>
      <li>Components in <em>elements</em> can have dependencies in <em>common</em>.</li>
      <li>Components in <em>site</em> can have dependencies in <em>common</em> and <em>site</em>.</li>
